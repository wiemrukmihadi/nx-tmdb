...
import { Avatar, Card, ImageListItem, ImageListItemBar, Rating, Tooltip } from '@mui/material';
              ...
              <ImageListItemBar
                ...
                actionIcon={
                  <Tooltip title={props.item.title} sx={{ mr: '5px'}}>
                    <Avatar src={`https://www.themoviedb.org/t/p/w300_and_h450_face${props.item.backdrop_path}`}>
